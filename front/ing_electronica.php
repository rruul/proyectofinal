<?php
    include '../back/ing_electronica.php';
?>
...
<head>
  ...
  <title>Agenda de personal de ingenieria electronica</title>
</head>
...
<body>
  ...
  <main>
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          <h2 class="text-center mb-3">Personal del departamento de Ingenieria electronica</h2>
        </div>
      </div>
      <div class="row">
  ...
  <script src="../js/ing_electronica.js"></script>
